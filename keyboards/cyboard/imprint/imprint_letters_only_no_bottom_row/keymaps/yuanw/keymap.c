...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_let_no_bottom_row(
        ...
        KC_B,    HRM_C,   HRM_I,   HRM_A,  HRM_E,   KC_SCLN,                             KC_K,    HRM_H,   HRM_T,   HRM_N,   HRM_S, KC_F,
        XXXXXXX, KC_QUOT, KC_MINS, LT(SYM,KC_COMM), KC_DOT,  KC_SLASH,                   KC_J,    KC_M,    LT(SYM,KC_G),    KC_P,   KC_V,  XXXXXXX,
