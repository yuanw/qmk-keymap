#!/usr/bin/env python3
"""Expand LAYOUT_LR (35 keys) to LAYOUT_let_no_bottom_row (48 keys) for imprint."""

import json
import sys

def expand_layer(layer_35):
    """
    Expand a 35-key LAYOUT_LR layer to 48-key LAYOUT_let_no_bottom_row.

    LAYOUT_LR input (35 keys):
      ...
      L20 L21 L22 L23 L24    R20 R21 R22 R23 R24   <- indices 20-29
                LT0 LT1 LT2       RT0 RT1          <- indices 30-34
    ...
    LAYOUT_let_no_bottom_row output (48 keys):
      ...
      X   L20 L21 L22 L23 L24    R20 R21 R22 R23 R24 X    <- Row 2 (12 keys)
                  ...
                  LT0 LT1 LT2      AREP RT0 RT1           <- Bottom thumbs (6 keys)
    """
    layer_48 = []

    # Row 0: X + L00-L04 + R00-R04 + X
    layer_48.append("KC_NO")
    layer_48.extend(layer_35[0:5])   # L00-L04
    layer_48.extend(layer_35[5:10])  # R00-R04
    layer_48.append("KC_NO")

    # Row 1: B + L10-L14 + R10-R14 + W
    layer_48.append("KC_B")
    layer_48.extend(layer_35[10:15])  # L10-L14
    layer_48.extend(layer_35[15:20])  # R10-R14
    layer_48.append("KC_W")

    # Row 2: X + L20-L24 + R20-R24 + X
    layer_48.append("KC_NO")
    layer_48.extend(layer_35[20:25])  # L20-L24
    layer_48.extend(layer_35[25:30])  # R20-R24
    layer_48.append("KC_NO")

    # Top thumbs: 6 X's
    layer_48.extend(["KC_NO"] * 6)

    # Bottom thumbs: LT0 LT1 LT2 + QK_AREP + RT0 RT1
    layer_48.extend(layer_35[30:33])  # LT0-LT2
    layer_48.append("QK_AREP")        # Extra key
    layer_48.extend(layer_35[33:35])  # RT0-RT1
